...
<body>
<div class="location">
	当前位置:&nbsp;<a id="first" href="main.do">首页</a>&nbsp;&gt;&nbsp;<a>部门管理</a>&nbsp;&gt;&nbsp;<a href="#" id="third">修改部门</a>
</div>
...
<table width="70%" cellpadding="0" cellspacing="0" >
	<tr>
		...
		<td><input type="text" name="d_name" id="d_name" class="txtinput fl" placeholder="${department.dname}"/><p id="checkname" class="fl"></p></td>
	</tr>
	<tr>
